...
```{r, echo = TRUE, warning = FALSE, message = FALSE, fig.cap= "The Graph of Volume against Temperature", fig.align="left"}
...
```{r, echo = TRUE, warning = FALSE, message = FALSE, fig.cap= "Solving simultaneous linear equations using graphical methods", fig.align="left"}
