...
```{r, echo = FALSE, warning = FALSE, message = FALSE, fig.cap= "Solving simultaneous linear equations using graphical methods", fig.align="left"}
...
interception as displayed in @fig-cap: From the graph, the values of x
...
2.  Copy and complete the tables below for:
    ...
    \hspace{3.2cm}(4mks) ![](images/Cpt15_Q2.png)

    b\) On a graph paper and on the same grid draw the two linear
    equations in (a) above. \hspace{3.2cm} (4mks)
