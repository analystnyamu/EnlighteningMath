...
**Mass**, is the quantity of matter in an object? The Mass of an
...
**Density**, is mass per unit volume. Its SI unit is Kilogram per
Cubic meter ($kgm^-3$)
...
**Note:** Since mass is proportional to volume for the same
...
b\) The mass of the empty box in Kilograms to 3 significant figures.      $\hspace{1cm}    (3mks)$
...
2.  $2000 cm\^3$ of a mixture consists of 2.5 kg of substance x and 7.5
