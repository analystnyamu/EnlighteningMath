...
## Solution
 ...
 Substituting equation __(ii)__ into __(i)__;
...
1.  Solve the following equations \hspace{9.5 cm} $(4mks)$
...
2.  Solve the simultaneous equations. \hspace{8.7 cm} $(3mks)$ 
...
3.  Solve the simultaneous equations: \hspace{8.5 cm} $(3mks)$
...
4.  Mercy a student at Mucagara mixed Secondary bought 5 pens and 3
    ...
    exercise book. \hspace{13.2 cm} $(4mks)$
...
9.  Four men took their cows to the market. John had two more cows than
    ...
    the total number of cows. \hspace{13.6cm} $(1mk)$
...
12. Karani bought 4 pencils and 6 blades for $Ksh.\, 66$ and Kanuni
    ...
    pencils, find the number of pencils bought. \hspace{13.5cm} $(3mks)$
