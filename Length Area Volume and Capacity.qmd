...
# Chapter 10: Length, Area, Volume, and Capacity {.unnumbered}

## Length, Area, Volume, and Capacity {.unnumbered}

**Length**, is the distance between two points. Its SI Unit is the
...
surface area of this ball.  $(4mks)$
:::
...
1.  An arc of length 'x' cm subtends an angle of, $(\frac{p}{\pi})^0$,at
    ...
    the circle in terms of x and p.  $(3mks)$
...
2.  Find the length of the minute hand of a wall clock if the tip of the
    ...
    (Give your answer in terms of $\pi$).  $(3mks)$
...
4.  The figure below shows a circle Centre O. Chord AB subtends $30^0$
    ...
    $\triangle \,OAB=\frac{1}{2}r^2sin(\theta)$  $(3mks)$
...
5.  The curved surface area of a cylindrical container is $2,112\,cm^2$.
    ...
    place the capacity of the container in litres     $(3mks)$
...
8.  A solid hemisphere of radius 7cm has the same volume as a cube. Find
    the length of the cube to 3 significant figures. 
    $(3mks)$
...
10. An open box has an external breadth of 12 cm, a height 10 cm, and a
    ...
    cm, find the total surface area of the box.   $(5mks)$
